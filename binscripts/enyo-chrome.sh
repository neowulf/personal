...
/Applications/Google\ Chrome.app/Contents/MacOS/Google\ Chrome --user-data-dir=/Users/sivakom/applications/chrome/datadir --allow-file-access-from-files --disable-web-security --allow-outdated-plugins --always-authorize-plugins $@ %U > /dev/null 2> /dev/null &
